package tag.amazon;// A Java program to order of
...
public class AlienDictionary_1 {
    ...
    private static void printOrder(String[] words, int alpha) {
        ...
        for (int i = 0; i < graph.adjacencyList.length; i++) {
            System.out.println(graph.adjacencyList[i].toString());
        }
    }
    ...
    public static void main(String[] args) {
        String[] words = {"bhhb", "blkbggfecalifjfcbkjdicehhgikkdhlachlgbhji", "cfjjhcifladadbgcleggjgbcieihabcglblflgajgkejccj", "dlgdhiha", "ehggedljjhfldcajeceaeehkalkfeidhigkifjl", "gdalgkblahcldahledfghjb", "geldbblaaflegjhlfjlgblfbdc", "ibjceciedbiilkjliijgklcgliaeeic", "jcebjkfgfibfckfiikklecihik", "jdkcabjjjckgdblkljf", "jijlbjbliigkffhkchkclkhafbiiiblcglhfjkflbjjkih", "kfd", "lhdgidialgabfklffahiihceflebfidl"};
        printOrder(words, 12);
    }
}
